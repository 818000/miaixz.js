...
/**
 * @ts-expect-error View.Selector was removed in favor of Segmented. */
void View.Selector;
/**
 * @ts-expect-error ViewSelectorProps was removed in favor of SegmentedProps. */
import type { ViewSelectorProps } from "../src/index.js";
/**
 * @ts-expect-error Range was renamed outright to Slider. */
import { Range } from "../src/index.js";
/**
 * @ts-expect-error RangeProps was renamed outright to SliderProps. */
import type { RangeProps } from "../src/index.js";

/**
 * @ts-expect-error Preset definitions are discovered dynamically instead of named exports. */
import { miaixzTheme } from "../src/theme/index.js";

/**
 * @ts-expect-error Preset definitions are discovered dynamically instead of named exports. */
import { neutralTheme } from "../src/theme/index.js";

/**
 * @ts-expect-error Preset definitions are discovered dynamically instead of named exports. */
import { contrastTheme } from "../src/theme/index.js";
...
void [
  ...
  getMetricClassName,
  getNoticeClassName,
  applyMiaixzAppearance,
  validateMiaixzThemeContrast,
  miaixzLightThemeColors,
  miaixzDarkThemeColors,
];

type RemovedRelationMapTypes = RelationMapProps | MiaixzRelationNode | MiaixzRelationEdge;
declare const removedRelationMapTypes: RemovedRelationMapTypes;
void removedRelationMapTypes;

type RemovedCompatibilityTypes =
  | ConfirmDialogProps
  | InlineMessageProps
  | FormFieldProps
  | SearchInputProps
  ...
  | VisuallyHiddenProps
  | BodyProps
  | LocalePickerOwnerState
  | LocalePickerProps
  | LocalePickerRootAttributes
  | LocalePickerSlot
  | LocalePickerSlotProps
  | MetricGroupProps
  | ModuleFrameDensity
  | ModuleFrameMode
  | ModuleFrameModeProps
  | ModuleFrameOwnerState
  | ModuleFrameProps
  | ModuleFrameRootAttributes
  | ModuleFrameSlot
  | ModuleFrameSlotProps
  | ModuleFrameSurface
  | GroupedListGroup
  | GroupedListItem
  | GroupedListLayout
  | GroupedListOwnerState
  | GroupedListProps
  | GroupedListRootAttributes
  | GroupedListSlot
  | GroupedListSlotProps
  | MiaixzGroupedListOwnProps
  | StickyProps
  | DropzonePanelProps
  ...
  | ListPart
  | MetricPart;
declare const removedCompatibilityTypes: RemovedCompatibilityTypes;
void removedCompatibilityTypes;
