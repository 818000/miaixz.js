...
import type { TransferOwnerState, TransferProps } from "../components/transfer/transfer.types.js";
...
export interface MiaixzThemeComponentRegistry {
  ...
  >;
  readonly Transfer: MiaixzThemeEntry<TransferProps, TransferOwnerState>;
