...
import type { MiaixzThemeOpacity } from "../design/opacity.js";
import type { MiaixzThemeRadius } from "../design/radius.js";
import type { MiaixzThemeShadow } from "../design/shadow.js";
import type { MiaixzThemeSurfaces } from "../design/surfaces.js";
import type { MiaixzThemeTypography } from "../design/typography.js";
...
export interface MiaixzResolvedThemeGeometry extends Readonly<
  Record<MiaixzDensity, Required<import("../design/geometry.js").MiaixzThemeDensityGeometry>>
> {
  /**
   * Complete layout geometry.
   */
  readonly layout: Required<import("../design/geometry.js").MiaixzThemeLayoutGeometry>;
}
