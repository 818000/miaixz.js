...
import { InlineMessage } from "../inline-message/index.js";
...
export function ConfirmDialog(props: ConfirmDialogProps) {
  ...
  return (
    <Dialog
      ...
      className="miaixz-confirm-dialog"
    >
      <div className="miaixz-confirm-dialog-content">
        <Button
          className="miaixz-confirm-dialog-cancel"
          disabled={isPending}
        ...
        {confirmationText !== undefined && (
          <div className="miaixz-confirm-dialog-input">
            <Input
        ...
        {error !== undefined && (
          <InlineMessage tone="danger" className="miaixz-confirm-dialog-error">
            {error}
          </InlineMessage>
        )}
        <Button
          className="miaixz-confirm-dialog-confirm"
