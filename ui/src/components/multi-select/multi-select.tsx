...
import type { MultiSelectProps } from "./multi-select.types.js";

/**
 * Renders the public multiple-value MultiSelect adapter.
 *
 ...
 */
function MultiSelectImplementation<Value extends string = string>(
 ...
 * @public
 */
export const MultiSelect = forwardRef(MultiSelectImplementation) as <Value extends string = string>(
  props: MultiSelectProps<Value> & RefAttributes<HTMLDivElement>,
) => ReactElement;
