...
/**
 * Defines properties owned by the Miaixz FileUpload contract.
 *
 * @public
 */
export interface MiaixzFileUploadOwnProps {
  /**
...
export interface FileUploadProps
  extends
    Omit<HTMLAttributes<HTMLDivElement>, keyof MiaixzFileUploadOwnProps>,
    MiaixzFileUploadOwnProps {}
