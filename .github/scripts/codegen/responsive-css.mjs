...
if (uiWorkspace === undefined)
  throw new Error("Responsive CSS generation requires the UI workspace");
...
const prettierConfiguration = (await resolveConfig(outputPath)) ?? {};
...
function serializeResponsive(breakpoints, mediaQueries, containers) {
  ...
  return [
    sourceHeader,
    "",
    "/**\n * Generated by .github/scripts/codegen/responsive-css.mjs; do not edit.\n */",
    "",
    "[data-miaixz-theme] {",
